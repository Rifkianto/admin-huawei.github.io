          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <p class="text-muted text-center">Web Staff Developer</p>

                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Followers</b> <a class="float-right">15k</a>
                  </li>
                  <li class="list-group-item">
                    <b>Following</b> <a class="float-right">375</a>
                  </li>
                  <li class="list-group-item">
                    <b>Friends</b> <a class="float-right">5k</a>
                  </li>
                </ul>
              </div>
              <!-- /.card-body -->
